...
% of several microenvironmental gradients.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for lN=1:3
        ...
        for lb=1:3
            ...
            for lG=gg:gg
                ...
                for lk=1:9
                    k1=0.1*lk;
                    Q=readmatrix(['G4N' num2str(N) 'G' num2str(G) 'be' num2str(beta) 'k' num2str(10*k1) '.txt']);
                    p=(sort(Q(:,1:4)'))';
                    avp(lG,lk,:)=mean(p,1);
                    stdp(lG,lk,:)=std(p);
                end
...
for lN=1:3
    ...
    for lb=1:3
        ...
        if (lb==2)&&(lN==1)
            legend('G=8','G=32','FontSize',25,'Location','northeast')
        end
